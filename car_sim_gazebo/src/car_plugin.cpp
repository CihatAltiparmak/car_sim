#include <car_sim_gazebo/car_plugin.hpp>
...
void CarPlugin::Load(physics::ModelPtr model, sdf::ElementPtr sdf) {
  ...
  update_connection_ = event::Events::ConnectWorldUpdateBegin(boost::bind(&CarPlugin::OnUpdate, this, _1));
  ...
  sub_steering_cmd_ = ros_node_->create_subscription<example_interfaces::msg::Float64>("steering_cmd", 1, std::bind(&CarPlugin::recvSteeringCmd, this, std::placeholders::_1));
  sub_brake_cmd_ = ros_node_->create_subscription<example_interfaces::msg::Float64>("brake_cmd", 1, std::bind(&CarPlugin::recvBrakeCmd, this, std::placeholders::_1));
  sub_throttle_cmd_ = ros_node_->create_subscription<example_interfaces::msg::Float64>("throttle_cmd", 1, std::bind(&CarPlugin::recvThrottleCmd, this, std::placeholders::_1));
  sub_gear_cmd_ = ros_node_->create_subscription<example_interfaces::msg::UInt8>("gear_cmd", 1, std::bind(&CarPlugin::recvGearCmd, this, std::placeholders::_1));
...
void CarPlugin::OnUpdate(const common::UpdateInfo& info) {
...
void CarPlugin::twistStateUpdate() {
...
void CarPlugin::steeringUpdate(double time_step) {
...
void CarPlugin::setAllWheelTorque(double torque) {
...
void CarPlugin::recvSteeringCmd(const example_interfaces::msg::Float64::ConstSharedPtr msg) {
...
void CarPlugin::recvBrakeCmd(const example_interfaces::msg::Float64::ConstSharedPtr msg) {
  brake_cmd_ = msg->data;
  if (brake_cmd_ < 0) {
    brake_cmd_ = 0;
...
void CarPlugin::recvThrottleCmd(const example_interfaces::msg::Float64::ConstSharedPtr msg) {
...
void CarPlugin::recvGearCmd(const example_interfaces::msg::UInt8::ConstSharedPtr msg) {
  if (msg->data > REVERSE) {
...
void CarPlugin::feedbackTimerCallback() {
...
void CarPlugin::tfTimerCallback() {
  auto current_ros_time = gazebo_ros::Convert<builtin_interfaces::msg::Time>(last_update_time_);
